...
import static org.springframework.cloud.fn.supplier.sftp.SftpSupplierFactoryConfiguration.DelegatingFactoryWrapper;
...
public class SftpSupplierConfiguration {
	...
	public ChainFileListFilter<LsEntry> chainFilter(SftpSupplierProperties sftpSupplierProperties,
		...
		chainFilter.addFilter(files -> Arrays.asList(files));
	...
	static class StreamingConfiguration {
		...
		@Bean
		public SftpRemoteFileTemplate sftpTemplate(DelegatingFactoryWrapper wrapper) {
