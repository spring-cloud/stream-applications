...
The consumer uses the RSocket support from https://docs.spring.io/spring-integration/reference/html/rsocket.html[Spring Integration].
...
For more information on the various options available, please see link:src/main/java/org/springframework/cloud/fn/consumer/rsocket/RsocketConsumerProperties.java[RsocketConsumerProperties] and
