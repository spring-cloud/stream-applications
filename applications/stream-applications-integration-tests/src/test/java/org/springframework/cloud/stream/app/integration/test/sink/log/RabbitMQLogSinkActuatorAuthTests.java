...
@RabbitMQBaseContainer(name = "log-sink-rabbit", versionSupplier = Configuration.VersionSupplier.class)
public class RabbitMQLogSinkActuatorAuthTests extends LogSinkActuatorAuthTests {
}
