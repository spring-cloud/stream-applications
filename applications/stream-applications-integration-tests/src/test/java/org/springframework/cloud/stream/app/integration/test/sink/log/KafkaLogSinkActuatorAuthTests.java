...
@KafkaStreamAppTest
@KafkaBaseContainer(name = "log-sink-kafka", versionSupplier = Configuration.VersionSupplier.class)
public class KafkaLogSinkActuatorAuthTests extends LogSinkActuatorAuthTests {
}
